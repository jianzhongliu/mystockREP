...
@interface DownToRaiseListViewController () <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate>
...
@implementation DownToRaiseListViewController
...
//    [self.arrayShen addObjectsFromArray:[colorModel getSA]];
    NSMutableArray *arrayLocalStock = [NSMutableArray arrayWithArray:[[CaculationFunction share] lowStartHeighStop]];
...
- (void)initUI {
    ...
    titleLabel.text = [NSString stringWithFormat:@"低开高走，72/100&&%ld",self.arrayDouble.count];

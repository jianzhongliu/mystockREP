...
@interface UpTodayListViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation UpTodayListViewController
...
//    [colorModel getStockCodeInfo];
    self.arrayLow = [NSMutableArray arrayWithArray:[[CaculationFunction share] daysUpOfNow]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *stringTitle = [NSString stringWithFormat:@"%@ // %@", [self.arrayLow[indexPath.row] objectForKey:@"stockname"], [self.arrayLow[indexPath.row] objectForKey:@"updayrate"]];

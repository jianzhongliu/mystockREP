...
@interface DownDayListViewController () <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate>
...
@implementation DownDayListViewController
...
//    [self.arrayShen addObjectsFromArray:[colorModel getSA]];
    NSMutableArray *arrayLocalStock = [NSMutableArray arrayWithArray:[[CaculationFunction share] downStockesDownDays]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *stringTitle = [NSString stringWithFormat:@"%@ // %@=====%@", [self.arrayDouble[indexPath.row] objectForKey:@"stockname"], [self.arrayDouble[indexPath.row] objectForKey:@"stockcode"],[self.arrayDouble[indexPath.row] objectForKey:@"downcount"]];

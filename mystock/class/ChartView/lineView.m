...
-(id)init{
    self = [super init];
    self.dicStock = [NSDictionary dictionary];
    [self initSet];
    return self;
}
...
-(NSString*)changeUrl{
    ...
    NSString *url = [NSString stringWithFormat:@"http://hq.niuguwang.com/aquote/quotedata/KLine.ashx?ex=1&code=%@&type=5&count=300&packtype=0&version=2.0.5", [self.dicStock objectForKey:@"innercode"]];
    return url;
}
...
-(void)drawLine{
    ...
    getdata = [getdata initWithUrl:[self changeUrl] stock:self.dicStock];
